...
In this lab, we will further improve the initial load of our Angular app by using server-side rendering. Once again, you could also apply the same optimizations to your own App - if you prefer to do that. Please keep in mind that this only works for **public** routes which are not dependent on a **login**.
...
```json
"build:serve": "ng build && serve dist/[app-name]/browser -s",
"serve": "serve dist/[app-name]/browser -s",
[...]
"build:sme": "ng b && source-map-explorer dist/[app-name]/browser/**/*.js",
"sme": "source-map-explorer dist/[app-name]/browser/**/*.js",
[...]
```
