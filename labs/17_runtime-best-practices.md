...
In this lab, we will apply some more runtime best practices to our Angular app including RxJS subscription management. Later, you can also apply the same optimizations to your own Angular App.
