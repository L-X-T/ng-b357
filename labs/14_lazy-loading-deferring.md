...
In this lab, we will further improve the initial load of our Angular app by using lazy loading. Of course, you could also apply the same optimizations to your own App - if you prefer to do that.
